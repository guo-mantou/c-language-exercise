...
#define MYULONG_MAX     (unsigned long)cal2ex_int(64) - 1
#define MYFLT_MAX       (cal2ex_int(24)-1)*cal2ex_int(104)
#define MYFLT_MIN       -((cal2ex_int(24)-1)*cal2ex_int(104))
...
void print_range_direct_compute()
{
    ...
    PRINT_FLOAT(MYFLT_MAX, MYFLT_MIN);
    print_dashes(DASHLENGTH);
    printf("\n");
}
